...
class TelegramBotPoller:
    ...
    def _menu_text(self) -> str:
        return (
            ...
            "📊 <b>Честные ожидания</b> (проверено вне выборки)\n"
    ...
    def _about_text(self) -> str:
        return (
            ...
            "ориентиры — десятки процентов в год (CAGR ~30–45%) при управляемой просадке\n"
            "• <b>Проверяемость:</b> результаты вне выборки (walk-forward), воспроизводятся "
            "скриптами из открытого репозитория и подтверждены независимыми движками\n"
