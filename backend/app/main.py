...
async def momentum_start(data: dict = None):
    ...
    config = RotationConfig(
        ...
        adx_min=float(d.get("adx_min", d.get("adx_threshold", 22.0))),
        min_hold_days=int(d.get("min_hold_days", 3)),
        max_leverage=float(d.get("max_leverage", d.get("leverage", 2.0))),
        risk_per_trade=float(d.get("risk_per_trade", 0.05)),
        trail_atr_mult=float(d.get("trail_atr_mult", 0.1)),
        partial_tp_pct=float(d.get("partial_tp_pct", d.get("tp1_pct", 0.10))),
