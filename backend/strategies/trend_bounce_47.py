# @name: Trend Bounce Scalping (47%)
# @description: Trend Bounce (структурный) + EMA50. swing=15, ema=50, size_pct=0.80, без RSI-фильтра. Частые сигналы, низкая доходность. Бэктест: +45% годовых, DD 12.1%, PF 1.30. Для тестов/новичков.
# @timeframe: 5m
# @symbol: BTC-USDT-SWAP
# @params: {"ema_trend": 50, "swing_window": 15, "pullback_bars": 5, "size_pct": 0.80, "fee": 0.0005}
...
def generate_signals(df, params):
    ...
    swing_window = params.get("swing_window", 15)
