...
# @params: {"st_period": 20, "st_mult": 1.67, "ema_period": 70, "adx_period": 20, "adx_threshold": 25.93, "rsi_period": 20, "min_score": 18.91, "trailing_pct": 0.0226, "cooldown_bars": 6, "size_pct": 0.95, "fee": 0.0005, "leverage": 1, "use_atr_stops": false}
...
def generate_signals(df, params):
    ...
    trailing_pct = float(params.get("trailing_pct", 0.0226))
