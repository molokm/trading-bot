...
def main() -> None:
    ...
    print("\nОжидаемые результаты (только вне-выборочный форвард-тест, комиссия OKX 0.05%, плечо 2x):")
    print("  Форвард-тест 2024-2026: +102% за 2.4 года, CAGR ~33.5%, 0 ликвидаций")
    print("  (Результаты полного периода включают обучающее окно и намеренно не показываются)")
