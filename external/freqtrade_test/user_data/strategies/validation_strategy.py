...
# flake8: noqa: F401
# isort: skip_file
"""ValidationStrategy — freqtrade port of backend validation_strategy.py (demo).

Daily-bar rotation over ARB/OP/FIL/SUI/ATOM/LINK/DOT/NEAR USDT-M futures with relaxed filters:
