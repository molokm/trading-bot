# @name: Trend Bounce Scalping
# @description: Скальпинг на отскоках от тренда по стратегии Руслана Данилова. Вход у свинг-лоя после отката, стоп за лоем, выход при пробое структуры HH/HL.
# @timeframe: 5m
# @symbol: BTC-USDT
# @params: {"ema_trend": 50, "swing_window": 10, "pullback_bars": 5, "atr_period": 14, "atr_sl_mult": 1.5, "atr_tp_mult": 2.0, "risk_per_trade": 0.01}
